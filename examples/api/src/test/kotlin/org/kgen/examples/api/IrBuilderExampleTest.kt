...
class IrBuilderExampleTest {

    @Test
    fun addFunctionProducesValidModule() {
        val module = IrBuilderExample.buildAddFunction()
        ...
        assertEquals(1, function.blocks.size)

        val instructions = function.blocks[0].instructions
    ...
    fun addFunctionIrTextIsWellFormed() {
        val irText = IrPrinter.print(IrBuilderExample.buildAddFunction())
    ...
    fun absFunctionHasBranching() {
        val module = IrBuilderExample.buildAbsFunction()
        val function = module.functions[0]
    ...
    fun globalVariableExampleHasGlobal() {
        val module = IrBuilderExample.buildGlobalVariableExample()
    ...
    fun functionCallExampleHasTwoFunctions() {
        val module = IrBuilderExample.buildFunctionCallExample()
