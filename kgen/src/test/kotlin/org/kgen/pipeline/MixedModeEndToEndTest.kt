...
class MixedModeEndToEndTest {
    ...
    fun `native to managed upcall bridge generation`() {
        val builder = ModuleBuilder("upcall_test", Target.x86_64())
    ...
    fun `multi-module mixed mode with separate native and managed modules`() {
        ...
        val nativeBuilder = ModuleBuilder("compute_kernels", Target.x86_64())
        ...
        val managedBuilder = ModuleBuilder("app_logic", Target.x86_64())
    ...
    fun `bidirectional bridges with JNI name mangling`() {
        val builder = ModuleBuilder("bidirectional", Target.x86_64())
    ...
    private fun buildMixedModule(): Module {
        val builder = ModuleBuilder("mixed_app", Target.x86_64())
