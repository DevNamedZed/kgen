...
class X86DisassemblerTest {
    ...
    fun `VEX assembler round-trip`() {
        val asm = org.kgen.backend.x86.asm.X86Assembler()
        val eax = org.kgen.backend.x86.X86Register.EAX as org.kgen.backend.x86.X86Register32
        val ecx = org.kgen.backend.x86.X86Register.ECX as org.kgen.backend.x86.X86Register32
        val edx = org.kgen.backend.x86.X86Register.EDX as org.kgen.backend.x86.X86Operand32
