...
class Arm64AssemblerExtendedTest {
    ...
    private val X0 get() = Arm64Register.X0 as Arm64Register64
    private val X1 get() = Arm64Register.X1 as Arm64Register64
    private val X2 get() = Arm64Register.X2 as Arm64Register64
    private val X3 get() = Arm64Register.X3 as Arm64Register64
    private val X4 get() = Arm64Register.X4 as Arm64Register64
    private val X5 get() = Arm64Register.X5 as Arm64Register64
    private val X8 get() = Arm64Register.X8 as Arm64Register64
    private val X9 get() = Arm64Register.X9 as Arm64Register64
    private val X10 get() = Arm64Register.X10 as Arm64Register64
    private val X15 get() = Arm64Register.X15 as Arm64Register64
    private val X16 get() = Arm64Register.X16 as Arm64Register64
    private val X28 get() = Arm64Register.X28 as Arm64Register64
    private val X29 get() = Arm64Register.X29 as Arm64Register64
    private val X30 get() = Arm64Register.X30 as Arm64Register64
    private val SP get() = Arm64Register.SP as Arm64Register64
    private val W0 get() = Arm64Register.W0 as Arm64Register32
    private val W1 get() = Arm64Register.W1 as Arm64Register32
    private val W2 get() = Arm64Register.W2 as Arm64Register32
    private val W3 get() = Arm64Register.W3 as Arm64Register32
    private val W15 get() = Arm64Register.W15 as Arm64Register32
    private val D0 get() = Arm64Register.D0 as Arm64VecD
    private val D1 get() = Arm64Register.D1 as Arm64VecD
    private val D2 get() = Arm64Register.D2 as Arm64VecD
    private val D3 get() = Arm64Register.D3 as Arm64VecD
    private val S0 get() = Arm64Register.S0 as Arm64VecS
    private val S1 get() = Arm64Register.S1 as Arm64VecS
    private val S2 get() = Arm64Register.S2 as Arm64VecS
    ...
    fun loopFunction() {
        val bytes = assemble {
            mov(X0, Arm64Register.XZR as Arm64Register64) // result = 0
            label("loop")
