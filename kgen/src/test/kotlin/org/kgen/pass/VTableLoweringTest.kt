...
class VTableLoweringTest {
    ...
    fun virtualCallLoweredToIndirectCall() {
        ...
        builder.addClass(ClassDef(
            name = "Animal",
            methods = listOf(MethodDef("speak", listOf(Param("this", Type.OpaquePointer)), Type.I32)),
        ))
    ...
    fun interfaceCallLoweredToIndirectCall() {
        ...
        builder.addInterface(InterfaceDef(
            name = "Comparable",
            methods = listOf(MethodDef("compareTo", listOf(
    ...
    @Test
    fun noClassDefFallsBackToDirectCall() {
        val builder = IrBuilder("test", Target.x86_64())
    ...
    fun vtableSlotsAreAssignedSequentially() {
        ...
        builder.addClass(ClassDef(
            name = "Base",
            methods = listOf(
                MethodDef("methodA", listOf(Param("this", Type.OpaquePointer)), Type.Void),
                MethodDef("methodB", listOf(Param("this", Type.OpaquePointer)), Type.Void),
            ),
        ))
    ...
    fun inheritedSlotsPreserved() {
        ...
        builder.addClass(ClassDef(
            name = "Parent",
            methods = listOf(
                MethodDef("greet", listOf(Param("this", Type.OpaquePointer)), Type.Void),
            ),
        ))
        builder.addClass(ClassDef(
            name = "Child",
            ...
            methods = listOf(
                MethodDef("greet", listOf(Param("this", Type.OpaquePointer)), Type.Void),
                MethodDef("extra", listOf(Param("this", Type.OpaquePointer)), Type.Void),
            ),
        ))
    ...
    fun multipleVirtualCallsInSameFunction() {
        ...
        builder.addClass(ClassDef(
            name = "Shape",
            methods = listOf(
                MethodDef("area", listOf(Param("this", Type.OpaquePointer)), Type.I32),
                MethodDef("perimeter", listOf(Param("this", Type.OpaquePointer)), Type.I32),
            ),
        ))
    ...
    fun virtualCallWithReturnValuePreserved() {
        ...
        builder.addClass(ClassDef(
            name = "Getter",
            methods = listOf(
                MethodDef("getValue", listOf(Param("this", Type.OpaquePointer)), Type.I32),
            ),
        ))
    ...
    fun diamondInheritanceSlotAssignment() {
        ...
        builder.addClass(ClassDef(
            name = "A",
            methods = listOf(
                MethodDef("foo", listOf(Param("this", Type.OpaquePointer)), Type.Void),
            ),
        ))
        builder.addClass(ClassDef(
            name = "B",
            ...
            methods = listOf(
                MethodDef("foo", listOf(Param("this", Type.OpaquePointer)), Type.Void),
                MethodDef("bar", listOf(Param("this", Type.OpaquePointer)), Type.Void),
            ),
        ))
        builder.addClass(ClassDef(
            name = "C",
            ...
            methods = listOf(
                MethodDef("foo", listOf(Param("this", Type.OpaquePointer)), Type.Void),
                MethodDef("baz", listOf(Param("this", Type.OpaquePointer)), Type.Void),
            ),
        ))
    ...
    fun interfaceCallPreservesAllArguments() {
        ...
        builder.addInterface(InterfaceDef(
            name = "BiFunction",
            methods = listOf(MethodDef("apply", listOf(
