...
class RiscVAssembler {
    ...
    fun emitRaw(value: Int) = emit32(value)
    ...
    fun fmaddS(rd: RiscVFpReg, rs1: RiscVFpReg, rs2: RiscVFpReg, rs3: RiscVFpReg, rm: Int = 7) {
        emit32((rs3.encoding shl 27) or (0x00 shl 25) or (rs2.encoding shl 20) or (rs1.encoding shl 15) or (rm shl 12) or (rd.encoding shl 7) or 0x43)
    }
    fun fmaddD(rd: RiscVFpReg, rs1: RiscVFpReg, rs2: RiscVFpReg, rs3: RiscVFpReg, rm: Int = 7) {
        emit32((rs3.encoding shl 27) or (0x01 shl 25) or (rs2.encoding shl 20) or (rs1.encoding shl 15) or (rm shl 12) or (rd.encoding shl 7) or 0x43)
    }
