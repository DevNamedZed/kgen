...
class LinkTimeOptimization(
    private val pipeline: PassPipeline = defaultPipeline(),
) {
    ...
    companion object {
        ...
        fun merge(modules: List<Module>): Module {
            ...
            val structMap = linkedMapOf<String?, StructDef>()
            val classMap = linkedMapOf<String, ClassDef>()
            val ifaceMap = linkedMapOf<String, InterfaceDef>()
            val enumMap = linkedMapOf<String, EnumDef>()
        ...
        @JvmStatic
        fun defaultPipeline(): PassPipeline = PassPipeline()
