...
/**
 * Coordinates safepoints across all threads running JIT-compiled code.
...
interface SafepointManager {
    ...
    /** Called by JIT'd code at a safepoint — polls and blocks if a stop is requested. */
    fun poll()

    /** The address of the safepoint poll page. JIT'd code loads from this address;
