...
abstract class X86AssemblerOps {
    ...
    /** Move: r/m8, r8 */
    fun mov(rm1: X86Operand8, r2: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(136), modrmMode = ModrmMode.REG), rm1, r2)
    }
    ...
    /** Move: r/m16, r16 */
    fun mov(rm1: X86Operand16, r2: X86Register16) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(137), modrmMode = ModrmMode.REG, mandatoryPrefix = 0x66), rm1, r2)
    }
    ...
    /** Move: r/m32, r32 */
    fun mov(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(137), modrmMode = ModrmMode.REG), rm1, r2)
    }
    ...
    /** Move: r/m64, r64 */
    fun mov(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(137), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    /** Move: al, moffs8 */
    fun mov(r1: X86Register8, offset: Long) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(160)), r1, offset)
    }
    ...
    fun xchg(r1: X86Register64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(144), rexW = true, plusReg = true), r1, r2)
    }

    /** Exchange: eax, r32 */
    fun xchg(r1: X86Register32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(144), plusReg = true), r1, r2)
    }

    /** Exchange: ax, r16 */
    fun xchg(r1: X86Register16, r2: X86Register16) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(144), mandatoryPrefix = 0x66, plusReg = true), r1, r2)
    }

    /** Exchange: r/m8, r8 */
    fun xchg(rm1: X86Operand8, r2: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(134), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Exchange: r/m16, r16 */
    fun xchg(rm1: X86Operand16, r2: X86Register16) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(135), modrmMode = ModrmMode.REG, mandatoryPrefix = 0x66), rm1, r2)
    }

    /** Exchange: r/m32, r32 */
    fun xchg(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(135), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Exchange: r/m64, r64 */
    fun xchg(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(135), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    fun cmpxchg(rm1: X86Operand8, r2: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 176), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Compare and exchange: r/m16, r16 */
    fun cmpxchg(rm1: X86Operand16, r2: X86Register16) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 177), modrmMode = ModrmMode.REG, mandatoryPrefix = 0x66), rm1, r2)
    }

    /** Compare and exchange: r/m32, r32 */
    fun cmpxchg(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 177), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Compare and exchange: r/m64, r64 */
    fun cmpxchg(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 177), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    fun xadd(rm1: X86Operand8, r2: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 192), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Exchange and add: r/m16, r16 */
    fun xadd(rm1: X86Operand16, r2: X86Register16) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 193), modrmMode = ModrmMode.REG, mandatoryPrefix = 0x66), rm1, r2)
    }

    /** Exchange and add: r/m32, r32 */
    fun xadd(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 193), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Exchange and add: r/m64, r64 */
    fun xadd(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 193), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    fun add(r1: X86Register8, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(4)), r1, imm)
    }

    /** Add: ax, imm16 */
    fun add(r1: X86Register16, imm: Short) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(5), mandatoryPrefix = 0x66), r1, imm)
    }

    /** Add: eax, imm32 */
    fun add(r1: X86Register32, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(5)), r1, imm)
    }

    /** Add: rax, imm32 */
    fun add(r1: X86Register64, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(5), rexW = true), r1, imm)
    }
    ...
    /** Add: r/m8, r8 */
    fun add(rm1: X86Operand8, r2: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(0), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Add: r/m16, r16 */
    fun add(rm1: X86Operand16, r2: X86Register16) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(1), modrmMode = ModrmMode.REG, mandatoryPrefix = 0x66), rm1, r2)
    }

    /** Add: r/m32, r32 */
    fun add(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(1), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Add: r/m64, r64 */
    fun add(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(1), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    /** Add with carry: al, imm8 */
    fun adc(r1: X86Register8, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(20)), r1, imm)
    }

    /** Add with carry: eax, imm32 */
    fun adc(r1: X86Register32, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(21)), r1, imm)
    }

    /** Add with carry: rax, imm32 */
    fun adc(r1: X86Register64, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(21), rexW = true), r1, imm)
    }
    ...
    fun adc(rm1: X86Operand8, r2: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(16), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Add with carry: r/m32, r32 */
    fun adc(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(17), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Add with carry: r/m64, r64 */
    fun adc(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(17), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    fun sub(r1: X86Register8, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(44)), r1, imm)
    }

    /** Subtract: eax, imm32 */
    fun sub(r1: X86Register32, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(45)), r1, imm)
    }

    /** Subtract: rax, imm32 */
    fun sub(r1: X86Register64, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(45), rexW = true), r1, imm)
    }
    ...
    /** Subtract: r/m8, r8 */
    fun sub(rm1: X86Operand8, r2: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(40), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Subtract: r/m32, r32 */
    fun sub(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(41), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Subtract: r/m64, r64 */
    fun sub(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(41), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    /** Subtract with borrow: al, imm8 */
    fun sbb(r1: X86Register8, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(28)), r1, imm)
    }

    /** Subtract with borrow: eax, imm32 */
    fun sbb(r1: X86Register32, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(29)), r1, imm)
    }

    /** Subtract with borrow: rax, imm32 */
    fun sbb(r1: X86Register64, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(29), rexW = true), r1, imm)
    }
    ...
    fun sbb(rm1: X86Operand8, r2: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(24), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Subtract with borrow: r/m32, r32 */
    fun sbb(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(25), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Subtract with borrow: r/m64, r64 */
    fun sbb(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(25), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    fun and_(r1: X86Register8, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(36)), r1, imm)
    }

    /** Logical AND: eax, imm32 */
    fun and_(r1: X86Register32, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(37)), r1, imm)
    }

    /** Logical AND: rax, imm32 */
    fun and_(r1: X86Register64, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(37), rexW = true), r1, imm)
    }
    ...
    /** Logical AND: r/m8, r8 */
    fun and_(rm1: X86Operand8, r2: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(32), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Logical AND: r/m32, r32 */
    fun and_(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(33), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Logical AND: r/m64, r64 */
    fun and_(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(33), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    fun or_(r1: X86Register8, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(12)), r1, imm)
    }

    /** Logical OR: eax, imm32 */
    fun or_(r1: X86Register32, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(13)), r1, imm)
    }

    /** Logical OR: rax, imm32 */
    fun or_(r1: X86Register64, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(13), rexW = true), r1, imm)
    }
    ...
    /** Logical OR: r/m8, r8 */
    fun or_(rm1: X86Operand8, r2: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(8), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Logical OR: r/m32, r32 */
    fun or_(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(9), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Logical OR: r/m64, r64 */
    fun or_(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(9), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    fun xor_(r1: X86Register8, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(52)), r1, imm)
    }

    /** Logical XOR: eax, imm32 */
    fun xor_(r1: X86Register32, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(53)), r1, imm)
    }

    /** Logical XOR: rax, imm32 */
    fun xor_(r1: X86Register64, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(53), rexW = true), r1, imm)
    }
    ...
    /** Logical XOR: r/m8, r8 */
    fun xor_(rm1: X86Operand8, r2: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(48), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Logical XOR: r/m32, r32 */
    fun xor_(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(49), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Logical XOR: r/m64, r64 */
    fun xor_(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(49), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    /** Logical compare (AND without storing result): al, imm8 */
    fun test(r1: X86Register8, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(168)), r1, imm)
    }

    /** Logical compare (AND without storing result): eax, imm32 */
    fun test(r1: X86Register32, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(169)), r1, imm)
    }

    /** Logical compare (AND without storing result): rax, imm32 */
    fun test(r1: X86Register64, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(169), rexW = true), r1, imm)
    }
    ...
    fun test(rm1: X86Operand8, r2: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(132), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Logical compare (AND without storing result): r/m32, r32 */
    fun test(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(133), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Logical compare (AND without storing result): r/m64, r64 */
    fun test(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(133), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    fun shld(rm1: X86Operand32, r2: X86Register32, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 164), modrmMode = ModrmMode.REG), rm1, r2, imm)
    }

    /** Double precision shift left: r/m32, r32, cl */
    fun shld(rm1: X86Operand32, r2: X86Register32, r3: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 165), modrmMode = ModrmMode.REG), rm1, r2, r3)
    }

    /** Double precision shift left: r/m64, r64, imm8 */
    fun shld(rm1: X86Operand64, r2: X86Register64, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 164), modrmMode = ModrmMode.REG, rexW = true), rm1, r2, imm)
    }

    /** Double precision shift left: r/m64, r64, cl */
    fun shld(rm1: X86Operand64, r2: X86Register64, r3: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 165), modrmMode = ModrmMode.REG, rexW = true), rm1, r2, r3)
    }

    /** Double precision shift right: r/m32, r32, imm8 */
    fun shrd(rm1: X86Operand32, r2: X86Register32, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 172), modrmMode = ModrmMode.REG), rm1, r2, imm)
    }

    /** Double precision shift right: r/m32, r32, cl */
    fun shrd(rm1: X86Operand32, r2: X86Register32, r3: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 173), modrmMode = ModrmMode.REG), rm1, r2, r3)
    }

    /** Double precision shift right: r/m64, r64, imm8 */
    fun shrd(rm1: X86Operand64, r2: X86Register64, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 172), modrmMode = ModrmMode.REG, rexW = true), rm1, r2, imm)
    }

    /** Double precision shift right: r/m64, r64, cl */
    fun shrd(rm1: X86Operand64, r2: X86Register64, r3: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 173), modrmMode = ModrmMode.REG, rexW = true), rm1, r2, r3)
    }

    /** Compare (SUB without storing result): al, imm8 */
    fun cmp(r1: X86Register8, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(60)), r1, imm)
    }

    /** Compare (SUB without storing result): eax, imm32 */
    fun cmp(r1: X86Register32, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(61)), r1, imm)
    }

    /** Compare (SUB without storing result): rax, imm32 */
    fun cmp(r1: X86Register64, imm: Int) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(61), rexW = true), r1, imm)
    }
    ...
    fun cmp(rm1: X86Operand8, r2: X86Register8) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(56), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Compare (SUB without storing result): r/m32, r32 */
    fun cmp(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(57), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Compare (SUB without storing result): r/m64, r64 */
    fun cmp(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(57), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    fun bt(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 163), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Bit test: r/m64, r64 */
    fun bt(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 163), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    fun bts(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 171), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Bit test and set: r/m64, r64 */
    fun bts(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 171), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    fun btr(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 179), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Bit test and reset: r/m64, r64 */
    fun btr(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 179), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    fun btc(rm1: X86Operand32, r2: X86Register32) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 187), modrmMode = ModrmMode.REG), rm1, r2)
    }

    /** Bit test and complement: r/m64, r64 */
    fun btc(rm1: X86Operand64, r2: X86Register64) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 187), modrmMode = ModrmMode.REG, rexW = true), rm1, r2)
    }
    ...
    fun movd(rm1: X86Operand32, xmm2: X86Xmm) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 126), modrmMode = ModrmMode.REG, mandatoryPrefix = 0x66), rm1, xmm2)
    }
    ...
    fun movq(rm1: X86Operand64, xmm2: X86Xmm) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 126), modrmMode = ModrmMode.REG, mandatoryPrefix = 0x66, rexW = true), rm1, xmm2)
    }
    ...
    fun extractps(rm1: X86Operand32, xmm2: X86Xmm, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 58, 23), modrmMode = ModrmMode.REG, mandatoryPrefix = 0x66), rm1, xmm2, imm)
    }
    ...
    fun pextrb(rm1: X86Operand8, xmm2: X86Xmm, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 58, 20), modrmMode = ModrmMode.REG, mandatoryPrefix = 0x66), rm1, xmm2, imm)
    }

    /** Extract dword: r/m32, xmm, imm8 */
    fun pextrd(rm1: X86Operand32, xmm2: X86Xmm, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 58, 22), modrmMode = ModrmMode.REG, mandatoryPrefix = 0x66), rm1, xmm2, imm)
    }

    /** Extract qword: r/m64, xmm, imm8 */
    fun pextrq(rm1: X86Operand64, xmm2: X86Xmm, imm: Byte) {
        encodeLegacy(X86EncodingInfo(opcode = intArrayOf(15, 58, 22), modrmMode = ModrmMode.REG, mandatoryPrefix = 0x66, rexW = true), rm1, xmm2, imm)
    }
