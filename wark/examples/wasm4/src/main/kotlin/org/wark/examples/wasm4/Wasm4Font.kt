...
/**
 * WASM-4 built-in 8x8 pixel font.
 *
 * 224 glyphs covering characters 32-255, 8 bytes per glyph.
 * Each byte is one row, MSB = leftmost pixel.
 * Bits are inverted: 0 = foreground, 1 = background.
 *
 * Index into the font with `(charCode - 32) * 8`.
 */
object Wasm4Font {

    const val GLYPH_SIZE = 8
    const val FIRST_CHAR = 32
    const val GLYPH_COUNT = 224

    val data: ByteArray = intArrayOf(
        // Space (32) and punctuation
        ...
        // DEL (127) and extended characters 128-255
